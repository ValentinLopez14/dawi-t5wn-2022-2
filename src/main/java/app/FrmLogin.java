...
public class FrmLogin extends JFrame {
	...
	void registrar() {
		...
		//Obtener un Usuario según los campos ingresados
		EntityManagerFactory fabrica = Persistence.createEntityManagerFactory("jpa_sesion01");
		EntityManager em = fabrica.createEntityManager();
		
		Usuario p;
		try {
			 p = em.createQuery("select p from Usuario p where p.usuario = :xusr and p.clave = :xcla", 
		...
		//mostrar los mensajes según el retorno
